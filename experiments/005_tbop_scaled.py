...
# Training
BATCH_SIZE = 128         # 256 OOMs on STE (16B/p + activations > 32GB)
MAX_ITERS = 4000
LEARNING_RATE = 4e-4     # scale LR: sqrt(128/64) * 3e-4 ≈ 4e-4
LR_DECAY_ITERS = 4000
WARMUP_ITERS = 200
MIN_LR = 3e-5
EVAL_INTERVAL = 250
...
def main():
    ...
    # Run both fresh at batch=512
    ste_log = train_model(train_data, val_data, vocab_size, itos, method="ste")
